package com.marcinjeznach.lab1.exc_3
...
class HelloApplication : Application() {
	...
	override fun start(stage: Stage) {
		...
		val mainView = MainView(toggleTask, MainView.Type.ToggleTrue)
		val mutex = Mutex()
		...
		jobs.forEach { j -> GlobalScope.launch(Dispatchers.JavaFx) { j.resume() } }
